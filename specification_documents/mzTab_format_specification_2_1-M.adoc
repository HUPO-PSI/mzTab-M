...
[[study_variable1-n-group]]
==== study_variable[1-n]-group

[cols=",",]
|=============================================================================
|*Description* |Grouping related `study_variable`s that belong to one experimental design factor in multi-factorial designs. Added in mzTab-M 2.1.
|*Type* |String
|*Mandatory* |False
|*Example* a|
....
MTD study_variable[2]-group timepoint

MTD study_variable[13]-group Genotype
....
|=============================================================================
