...
MTD	study_variable_group[1]-study_variable_refs	study_variable[1]
MTD	study_variable_group[4]-study_variable_refs	study_variable[2]\| study_variable[3]
...
[[study_variable_group1-n-study_variable_refs]]
==== study_variable_group[1-n]-study_variable_refs

[cols="20,80",]
|============================================================
|*Description* |Bar-separated references to the study variables that belong to this study variable group. This is the sole link between study variables and their group: each study variable MUST be referenced by exactly one study variable group.
|*Type* |Integer List
|*Mandatory* |False
|*Example* a|
----
