...
The mzTab-M format consists of four cross-referenced data tables: metadata (MTD), Small Molecule (SML), Small Molecule Feature (SMF), and Small Molecule Evidence (SME).
...
|*Example* a|
----
MTD	instrument[1]-name	[MS, MS:1000121, Q Exactive, ]
----
|============================================================
...
|*Example* a|
----
MTD	instrument[1]-analyzer[1]	[MS, MS:1000285, Orbitrap, ]
----
|============================================================
...
|*Example* a|
----
MTD	software[1]-setting[1]	Mass tolerance = 5 ppm
----
|============================================================
...
|*Example* a|
----
MTD	contact[1]-affiliation	University of Example
----
|============================================================
...
|*Example* a|
----
MTD	contact[1]-email	jane.doe@example.org
----
|============================================================
...
|*Example* a|
----
MTD	contact[1]-orcid	0000-0002-1825-0097
----
|============================================================
...
|*Example* a|
----
MTD	quantification_method	[MS, MS:1001838, label-free quantification, ]
----
|============================================================
...
|*Example* a|
----
MTD	sample[1]-tissue[1]	[BTO, BTO:0000141, blood plasma, ]
----
|============================================================
...
|*Example* a|
----
MTD	sample[1]-cell_type[1]	[CL, CL:0000084, T cell, ]
----
|============================================================
...
|*Example* a|
----
MTD	sample[1]-disease[1]	[DOID, DOID:9351, diabetes mellitus type 2, ]
----
|============================================================
...
|*Example* a|
----
MTD	sample[1]-description	Human plasma sample from a healthy control donor
----
|============================================================
...
|*Example* a|
----
MTD	sample[1]-custom[1]	Sample preparation batch A
----
|============================================================
...
|*Example* a|
----
MTD	ms_run[1]-location	file:///data/run01.mzML
----
|============================================================
...
|*Example* a|
----
MTD	ms_run[1]-hash	sha256:34f2d1f2f0e7c5d8a3b6c4d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7
----
|============================================================
...
|*Example* a|
----
MTD	ms_run[1]-hash_method	[MS, MS:1000569, SHA-256, ]
----
|============================================================
...
|*Example* a|
----
MTD	assay[1]-custom[1]	technical replicate 1
----
|============================================================
...
|*Example* a|
----
MTD	assay[1]-external_uri	https://example.org/assays/001
----
|============================================================
...
|*Example* a|
----
MTD	assay[1]-ms_run_ref[1]	ms_run[1]
----
|============================================================
...
|*Example* a|
----
MTD	study_variable[1]-description	Female subjects at day 0
----
|============================================================
...
|*Example* a|
----
MTD	study_variable[1]-average_function	[STATO, STATO:0000467, arithmetic mean, ]
----
|============================================================
...
|*Example* a|
----
MTD	study_variable[1]-variation_function	[STATO, STATO:0000256, standard deviation, ]
----
|============================================================
...
|*Example* a|
----
MTD	study_variable_group[1]-description	Biological sex of the donor
----
|============================================================
...
|*Example* a|
----
MTD	protocol[1]-name	Sample preparation
----
|============================================================
...
|*Example* a|
----
MTD	protocol[1]-description	Proteins were precipitated with cold methanol and the supernatant was collected.
----
|============================================================
...
|*Example* a|
----
MTD	protocol[1]-parameters[1]	[MSIO, MSIO:0000442, solvent composition, methanol:water 8:2]
----
|============================================================
...
|*Example* a|
----
MTD	cv[1]-uri	https://github.com/HUPO-PSI/psi-ms-CV
----
|============================================================
...
|*Example* a|
----
MTD	database[1]-version	2025-04-17
----
|============================================================
...
|*Example* a|
----
MTD	database[1]-uri	https://www.ebi.ac.uk/chebi/
----
|============================================================
...
A minimal example row looks like this:

----
SMH	SML_ID	database_identifier	chemical_name	reliability	abundance_assay[1]
SML	1	CHEBI:15377	Proline	[,,high,]	123.4
----
...
----
SMH	...	uri	...
SML	...	https://www.genome.jp/dbget-bin/www_bget?cpd:C00031	...
SML	...	https://www.hmdb.ca/metabolites/HMDB0001847	...
----
|============================================================
...
----
SFH	SMF_ID	SME_ID_REFS	exp_mass_to_charge	charge	retention_time_in_seconds
SMF	1	1	123.45	1	420
----
...
----
SEH	SME_ID	evidence_input_id	chemical_name	exp_mass_to_charge	charge
SME	1	Scan=12345	Proline	123.45	1
----
...
----
SEH	...	uri	...
SME	...	https://www.hmdb.ca/metabolites/HMDB00054	...
----
|============================================================
